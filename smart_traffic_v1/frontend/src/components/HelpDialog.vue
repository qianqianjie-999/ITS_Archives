    ...
    <div class="help-body">
      ...
      <main class="help-content" ref="contentRef">
        ...
        <section :id="sections[0].id">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr><td>服役时间排名</td><td>设备服役年限排名</td></tr>
        ...
        <section :id="sections[6].id">
          <h2>7. 数据统计</h2>
          <p>点击左侧菜单"统计报表"，按设备类型（信号灯、电子警察、违停球、卡口、结构化相机、后端设备）分Tab展示明细表，支持按质保状态、归属项目筛选和名称搜索。</p>
          <table><thead><tr><th>功能</th><th>说明</th></tr></thead><tbody>
            <tr><td>零件大盘</td><td>横跨全部设备类型汇总：相机总数、雷达总数、补光灯总数等</td></tr>
            <tr><td>项目概览</td><td>按项目维度统计各类型设备数量，横向对比</td></tr>
            <tr><td>明细表</td><td>分Tab查看每种设备的全部字段，含使用时长</td></tr>
            <tr><td>导出Excel</td><td>一键导出当前统计数据</td></tr>
          </tbody></table>
        </section>
        ...
        <section :id="sections[7].id">
          <h2>8. 服役时间排名</h2>
          <p>点击左侧菜单"服役时间排名"，按设备服役年限从长到短排列展示全部设备。支持按设备类型筛选和按名称搜索。服役年限 = 当前日期 - 项目验收日期，数据实时计算。</p>
        </section>
